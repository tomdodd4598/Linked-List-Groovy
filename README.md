Linked Lists Learning Langs - Groovy
====================================
...
A linked list program, originally based on [an example from Computerphile](https://www.youtube.com/watch?v=0ZEX_l0DFK0), written in Groovy.
